                            ...
                            if (service.mLIMEPref.getHanConvertNotify()) {
                                ...
                                if (nowvalue - storevalue > 60000) {
                                    if (service.mLIMEPref.getHanCovertOption() == 1) {
                                        android.widget.Toast.makeText(service, net.toload.main.hd.R.string.han_convert_ts,
                                                android.widget.Toast.LENGTH_SHORT).show();
                                    } else if (service.mLIMEPref.getHanCovertOption() == 2) {
                                        android.widget.Toast.makeText(service, net.toload.main.hd.R.string.han_convert_st,
                                                android.widget.Toast.LENGTH_SHORT).show();
                                    }
                                }
