...
public class LIMEService extends InputMethodService implements
    ...
    private void startForegroundService() {
        try {
            ...
            Notification notification = builder
                    ...
                    .setContentText("è¼¸å…¥æ³•æ??™åŸ·è¡Œä¸­")
    ...
    public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
        ...
        if (activeIM != null && activeIM.startsWith("dayi") && !mEnglishOnly) {
            ...
            if (event.isShiftPressed() || hasShiftPress) {
                String symbol = null;
                if (keyCode == KeyEvent.KEYCODE_COMMA) symbol = "ï¼?;
                else if (keyCode == KeyEvent.KEYCODE_PERIOD) symbol = "??;
                else if (keyCode == KeyEvent.KEYCODE_SLASH) symbol = "ï¼?;
                else if (keyCode == KeyEvent.KEYCODE_1) symbol = "ï¼?;
                else if (keyCode == KeyEvent.KEYCODE_SEMICOLON) symbol = "ï¼?;
            ...
            if (mDayiSymbolPrefix) {
                ...
                if (keyCode != KeyEvent.KEYCODE_SHIFT_LEFT && keyCode != KeyEvent.KEYCODE_SHIFT_RIGHT) {
                    ...
                    if (keyCode == KeyEvent.KEYCODE_COMMA) symbol = "ï¼?;
                        ...
                        if (event.isShiftPressed() || hasShiftPress) symbol = "ï¼?;
                        else symbol = "ï¼?;
                    }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_TAB: // Jeremy '12.6,22 Force bypassing tab processing to super if not on milestone 2
                ...
                if (!(LIMEMetaKeyKeyListener.getMetaState(mMetaState,
                    ...
                    break;
            case KeyEvent.KEYCODE_GRAVE: // ` (key left of 1) ??Ctrl+` cycles internal IMs (å¤§æ??”æ³¨??
    ...
    /**
     * Display the active IM name in the composing-text popup (å­—æ ¹?€) for 1.5 seconds.
