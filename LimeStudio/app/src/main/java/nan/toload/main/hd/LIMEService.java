...
import nan.toload.main.hd.candidate.CandidateInInputViewContainer;
import nan.toload.main.hd.candidate.CandidateView;
import nan.toload.main.hd.candidate.CandidateViewContainer;
...
public class LIMEService extends InputMethodService implements
     ...
     * 
     * NOTE: Removed custom insets logic to let Android 16+ handle it automatically.
     * The keyboard view extends into bottom inset via onMeasure.
     */
    @Override
    ...
    public synchronized void setSuggestions(List<Mapping> suggestions, boolean showNumber, String diplaySelkey) {
        ...
        if (suggestions != null && suggestions.size() > 0) {
            ...
            if ((!mFixedCandidateViewOn || hasPhysicalKeyPressed)
                ...
                mCandidateView = mCandidateViewStandAlone; // Jeremy '12,5,4 use standalone candidateView for physical
                ...
                if (hasPhysicalKeyPressed) {
                    // cancel the current composing first before closing soft keyboard and switched
                    // to physical keyboarding typing.
                    InputConnection ic = getCurrentInputConnection();
                    if (ic != null && mPredictionOn)
