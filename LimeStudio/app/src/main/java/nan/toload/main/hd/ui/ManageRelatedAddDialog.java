...
public class ManageRelatedAddDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle icicle) {
        ...
        btnManageRelatedCancel = view.findViewById(R.id.btnManageRelatedCancel);
        ...
        btnManageRelatedSave = view.findViewById(R.id.btnManageRelatedSave);
        btnManageRelatedSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MaterialAlertDialogBuilder(activity)
                        .setTitle(activity.getResources().getString(R.string.manage_related_dialog_add))
                        .setMessage(activity.getResources().getString(R.string.manage_related_dialog_add_message))
