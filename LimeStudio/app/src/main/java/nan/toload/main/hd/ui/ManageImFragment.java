...
public class ManageImFragment extends Fragment {
     ...
     * number.
     */
    public static ManageImFragment newInstance(int sectionNumber, String code, boolean b) {
    ...
    public void removeWord(int id) {
        ...
        datasource.removeById(this.table, String.valueOf(id));
        /*
         * try {
         * datasource.open();
         * datasource.close();
    ...
    public void addWord(String code, int score, String word) {
        ...
        // Jeremy '15,6,6 the record may already exist, use original add or update
        // mapping function in LIMEDB instead.
    ...
    public void updateWord(int id, String code, int score, String word) {
         ...
         * "\", ";
         * if(this.table.equals("phonetic")) //Jeremy '15,6,6 add no tone code (code3r)
         * with code ripped 3467
         * updatesql += Lime.DB_COLUMN_CODE3R + " = \"" +
         * Lime.formatSqlValue(code.replaceAll("[3467 ]", "")) + "\", ";
