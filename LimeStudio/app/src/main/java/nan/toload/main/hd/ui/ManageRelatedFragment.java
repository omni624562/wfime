...
public class ManageRelatedFragment extends Fragment {
    ...
    private RecyclerView recyclerManageRelated;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.recyclerManageRelated = rootView.findViewById(R.id.recyclerManageRelated);
        // Configure GridLayoutManager for 2 columns
        GridLayoutManager layoutManager = new GridLayoutManager(activity, 2);
        this.recyclerManageRelated.setLayoutManager(layoutManager);

        // Initialize adapter
        this.adapter = new ManageRelatedAdapter(new ArrayList<>());
        this.adapter.setOnItemClickListener((item, position) -> {
            FragmentTransaction ft = getFragmentManager().beginTransaction();
            ManageRelatedEditDialog dialog = ManageRelatedEditDialog.newInstance();
            dialog.setHandler(handler, item);
        ...
        // Handle AD Display
        // boolean paymentflag = mLIMEPref.getParameterBoolean(Lime.PAYMENT_FLAG,
        // false);
        // if(!paymentflag) {
        // /*VPon add.
        // adBannerLayout = (RelativeLayout) rootView.findViewById(R.id.adLayout);
        // vpadnBanner = new VpadnBanner(getActivity(), Lime.VPON_BANNER_ID,
    ...
    public void updateGridView(List<Related> relatedlist) {
        ...
        if (total > 0) {
            ...
            this.recyclerManageRelated.scrollToPosition(0);
        } else {
    ...
    public void removeRelated(int id) {
        ...
        datasource.removeById(Lime.DB_RELATED, String.valueOf(id));
        /*
         * try {
         * datasource.open();
         * datasource.close();
